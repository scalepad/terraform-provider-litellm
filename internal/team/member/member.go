...
type TeamMemberCreateResponse struct {
	...
	UpdatedTeamMemberships []UpdatedTeamMembership `json:"updated_team_memberships"`
}
...
// UpdatedTeamMembership represents a team membership with budget information from the API response
type UpdatedTeamMembership struct {
	UserID             string             `json:"user_id"`
	TeamID             string             `json:"team_id"`
...
// LitellmBudgetTable represents the budget table information
type LitellmBudgetTable struct {
	...
	TPMLimit            *int     `json:"tpm_limit"`
	RPMLimit            *int     `json:"rpm_limit"`
	ModelMaxBudget      *string  `json:"model_max_budget"`
	BudgetDuration      string   `json:"budget_duration"`
}
